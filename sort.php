...
if ($sort == 'name') {
    $qry = 'select * from form order by name ASC';
  }
elseif($sort == 'dob') {
    $qry = 'select * from form order by dob ASC';
  }
  elseif($sort == 'fathersname') {
    $qry = 'select * from form order by dob ASC';
  }
  elseif($sort == 'adharnumber') {
    $qry = 'select * from form order by dob ASC';
  }
  elseif($sort == 'phonenumber') {
    $qry = 'select * from form order by dob ASC';
  }
  elseif($sort == 'residingvillage') {
    $qry = 'select * from form order by dob ASC';
  }
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="index.html">Home</a></li>
            <li><a class="nav-link scrollto active" href="sort.html">Back</a></li>
        </ul>
